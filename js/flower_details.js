...
document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch(`https://flower-seal.onrender.com/flowers/flowers/${flowerId}/`)
...
function order_flower(flower) {
  ...
  button.addEventListener("click", () => {
    ...
    if (product_quantity <= flower.stock) {
      fetch("https://flower-seal.onrender.com/orders/create_order/", {
        method: "POST",
        headers: {
...
const CheckOrder = async (flowerId) => {
  ...
  try {
    const response = await fetch(
      `https://flower-seal.onrender.com/flowers/check_order/?flowerId=${flowerId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
const post_comment = (flowerId) => {
  ...
  comment_button.addEventListener("click", async (event) => {
    ...
    fetch("https://flower-seal.onrender.com/flowers/comments_api/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const get_comments = (flowerId) => {
  fetch(`https://flower-seal.onrender.com/flowers/get_comment/${flowerId}/`)
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
      displayComment(data);
  ...
  deleteButtons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      if (confirm("Are you sure you want to delete this comment?")) {
        fetch(`https://flower-seal.onrender.com/flowers/comments_api/${commentId}/`, {
          method: "DELETE",
        })
          .then((response) => {
            if (response.ok) {
